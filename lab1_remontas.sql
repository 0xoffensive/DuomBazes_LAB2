...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 07, 2024 at 12:34 AM
...
CREATE TRIGGER `darbas_added` BEFORE INSERT ON `atliktas_darbas` FOR EACH ROW BEGIN
	...
	UPDATE REMONTO_SUTARTIS SET remonto_kaina = NEW.bendra_kaina WHERE nr = NEW.fk_REMONTO_SUTARTISnr; 
...
('WBSWD93549PY43903', '2024-03-06', 10003, '2024-03-27', 260015, 260015, NULL, 'atsiskaityta', '98765432109', 101),
('WBA3B9G56ENR90821', '2024-03-09', 10014, NULL, 50140, 50000, '507.95', 'atsiskaityta', '88888888888', 102),
('WBA3B9G56ENR90821', '2024-03-04', 10015, '2024-03-30', 145675, 145675, NULL, 'atsiskaityta', '88888888888', 104),
...
('YS2R4X20005399405', '2024-03-11', 10022, '2024-03-12', 90000, 90000, '900.00', 'priimtas laukia eileje', '56789012345', 104);
...
--
ALTER TABLE `atliktas_darbas`
  MODIFY `ID_` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT for table `darbuotojas`
--
ALTER TABLE `darbuotojas`
  MODIFY `tabelio_nr` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=105;
...
--
ALTER TABLE `modelis`
  MODIFY `ID_` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
...
--
ALTER TABLE `remonto_sutartis`
  MODIFY `nr` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10023;
